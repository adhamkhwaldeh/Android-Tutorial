...
import com.son.jawad.ui_widgets.Adapters.ImagecashAdapter;
...
public class ImageCashFileActivity extends Activity {
    ...
    private ImagecashAdapter adapter;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.imagecashfile_layout);
        setupViews();
    }
    ...
    private void setupViews() {
        ...
        adapter = new ImagecashAdapter(300, this, URLS);
