...
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.normalizer.PhoneNormalizer;
...
import static com.son.jawad.tutoriallibrary.Providers.GeneralProvider.normalizer.PhoneNormalizer.*;
        ...
        if (cur != null) {
            if (cur.getCount() > 0) {
                ...
                while (cur.moveToNext()) {
                    ...
                    contact.phoneSimplified = simplifyPhoneNumber(contact.phone);
