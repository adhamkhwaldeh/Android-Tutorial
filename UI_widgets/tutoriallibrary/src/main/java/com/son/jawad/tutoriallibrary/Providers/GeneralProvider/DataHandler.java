package com.son.jawad.tutoriallibrary.Providers.GeneralProvider;
...
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.dataprovider.ContactsProvider;
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.dataprovider.IProvider;
...
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.db.ValuedHistoryRecord;
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.pojo.Pojo;
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.pojo.PojoComparator;
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.pojo.ShortcutsPojo;
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.utils.UserHandle;
...
public class DataHandler extends BroadcastReceiver
    ...
    public DataHandler(Context context) {
        ...
        IntentFilter intentFilter = new IntentFilter(LoadingTag.LOAD_OVER);
        this.context.getApplicationContext().registerReceiver(this, intentFilter);

        Intent i = new Intent(LoadingTag.START_LOAD);
    ...
    protected Intent providerName2Intent(String name) {
        ...
        className.append(LoadingTag.PackageNameProvider);
    ...
    private void handleProviderLoaded() {
        ...
        try {
            ...
            Intent i = new Intent(LoadingTag.FULL_LOAD_OVER);
            this.context.sendBroadcast(i);
