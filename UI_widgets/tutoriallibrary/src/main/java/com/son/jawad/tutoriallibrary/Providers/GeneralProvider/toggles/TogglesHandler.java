package com.son.jawad.tutoriallibrary.Providers.GeneralProvider.toggles;
...
public class TogglesHandler {
    ...
    private Boolean getAutorotationState() {
        return Settings.System.getInt(this.contentResolver,Settings.System.ACCELEROMETER_ROTATION, 0) == 1;
    }

    private void setAutorotationState(Boolean state) {
        Settings.System.putInt(this.contentResolver,Settings.System.ACCELEROMETER_ROTATION, (state) ? 1 : 0 );
    }
}
