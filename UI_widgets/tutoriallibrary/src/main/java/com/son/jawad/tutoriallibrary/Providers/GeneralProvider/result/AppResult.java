...
import com.son.jawad.tutoriallibrary.Providers.GeneralProvider.utils.SpaceTokenizer;
...
//        }
    ...
    protected Boolean popupMenuClickHandler(Context context, RecordAdapter parent, MenuItem item) {
        ...
        if (i == R.id.item_app_details) {
            launchAppDetails(context, appPojo);
            return true;
        } else if (i == R.id.item_app_uninstall) {
            launchUninstall(context, appPojo);
            return true;
        } else if (i == R.id.item_app_hibernate) {
            hibernate(context, appPojo);
            return true;
        } else if (i == R.id.item_exclude) {// remove item since it will be hiddden
            parent.removeResult(this);
            excludeFromAppList(context, appPojo);
            return true;
        } else if (i == R.id.item_tags_edit) {
